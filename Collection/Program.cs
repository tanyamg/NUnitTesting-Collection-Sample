...
namespace Collection
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Current count: " + collection.Count);
            Console.WriteLine("Current cappasity" + collection.Capacity);
            ...
            Console.WriteLine("Current collection: " + collection);
            Console.WriteLine("Print the firts ellement:" + collection[0]);
